...
export const stringConfig: AlgorithmConfig[] = [
  ...
  { name: 'LPS (Manacher)', slug: 'longest-palindrome', endpoint: 'longest-palindrome', category: 'string', inputType: 'text', inputLabel: 'Text', defaultInput: 'babad', description: 'Preprocesses the string to find all palindrome radii in a single linear pass. \nR1: mirror fits inside (not touching border) \u2192 copy length.\nR2: mirror reaches border \u2192 explore beyond.\nR3: mirror extends beyond \u2192 explore beyond larger palindrome.\nR4: outside any palindrome \u2192 explore from scratch.' },
...
export const treeConfig: AlgorithmConfig[] = [
  ...
  { name: 'Huffman Encoding', slug: 'huffman', endpoint: 'huffman', category: 'tree', inputType: 'text', inputLabel: 'Text', defaultInput: 'huffman encoding example', description: 'Builds a Huffman tree from character frequencies and generates optimal prefix-free binary codes.' },
];
