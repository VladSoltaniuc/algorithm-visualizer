...
export const algorithmRatings: Record<string, AlgorithmRating> = {
  ...
  "quick-sort":      { stars: 4, tooltip: "Default sort in most runtimes." },
  ...
  "climbing-stairs": { stars: 2, tooltip: "Teaching vehicle for DP recurrences, not something you reach for in production. The underlying Fibonacci pattern is what generalizes." },
  ...
  "preorder":           { stars: 4, tooltip: "Root-first traversal, used in tree serialization, cloning, and expression tree evaluation." },
  ...
  "invert":             { stars: 3, tooltip: "Classic interview question, but rarely needed in production. Tests tree manipulation and recursive thinking." },
  ...
  "boyer-moore":            { stars: 3, tooltip: "Fastest practical string search in many real-world scenarios; used in text editors and grep implementations." },
  ...
  "longest-palindrome":     { stars: 4, tooltip: "Used in substring analysis, symmetry detection, and string DP. Manacher's O(n) is impressive but the expand-around-center O(n²) approach is simpler and sufficient for most real problems. Worth knowing both." },
